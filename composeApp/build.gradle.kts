...
kotlin {
    ...
    buildkonfig {
        ...
        defaultConfigs {
            ...
            buildConfigField(com.codingfeline.buildkonfig.compiler.FieldSpec.Type.INT, "VERSION_CODE", "7")
            buildConfigField(com.codingfeline.buildkonfig.compiler.FieldSpec.Type.STRING, "VERSION_NAME", "1.0.5")
        }
    }
