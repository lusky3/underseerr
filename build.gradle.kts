...
buildscript {
    dependencies {
        constraints {
            ...
            classpath("io.netty:netty-codec:4.2.12.Final") { because("Fixes security vulnerabilities") }
            classpath("io.netty:netty-codec-http2:4.2.12.Final") { because("Fixes security vulnerabilities") }
            classpath("io.netty:netty-handler:4.2.12.Final") { because("Fixes security vulnerabilities") }
